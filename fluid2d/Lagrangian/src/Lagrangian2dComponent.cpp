...
namespace FluidSimulation
{
    namespace Lagrangian2d
    {
        ...
        void Lagrangian2dComponent::init()
        {
            ...
            solver->velocityAttenuation_ = Lagrangian2dPara::velocityAttenuation;
            solver->viscosity_ = Lagrangian2dPara::viscosity;
            solver->substeps_ = Lagrangian2dPara::substep;
            solver->dt_ = Lagrangian2dPara::dt;
            solver->density_ = Lagrangian2dPara::density;
            solver->stiffness_ = Lagrangian2dPara::stiffness;
            solver->exponent_ = Lagrangian2dPara::exponent;
            solver->gravityX_ = Lagrangian2dPara::gravityX;
            solver->gravityY_ = Lagrangian2dPara::gravityY;
            solver->maxVelocity_ = Lagrangian2dPara::maxVelocity;
