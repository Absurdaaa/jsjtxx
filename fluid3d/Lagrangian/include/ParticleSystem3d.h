...
namespace FluidSimulation
{
    namespace Lagrangian3d
    {
        ...
        public:
            ...
            // float particleVolume = std::pow(particleDiameter, 3);      // 粒子体积的
            float particleVolume = 4.0f / 3.0f * 3.14159265358979323846f * std::pow(particleRadius, 3); // 球体积公式
            
            float particleMass = Lagrangian3dPara::density * particleVolume; // 粒子质量
